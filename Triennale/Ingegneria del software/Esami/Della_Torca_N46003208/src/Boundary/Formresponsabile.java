...
public class Formresponsabile extends JFrame {
	...
	public String visualizza_richieste(String targa) {
		return Control.Controllerresponsabile.visualizza_richieste(targa);
	}
	...
	public Formresponsabile() {
		...
		buttonContaEsami.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String esito = visualizza_richieste(targa);
