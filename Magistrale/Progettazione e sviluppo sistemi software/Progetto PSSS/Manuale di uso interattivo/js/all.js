...
DR_EXPLAIN.data_menu = {
    // menu
    DREX_NODE_NAMES: ["Titolo","Effettua Login","Creazione di una cartella clinica","Visualizza cartella clinica attiva","Aggiornamento cartella clinica","Visualizza tutte le cartelle cliniche","Prenota un esame"],
    DREX_NODE_LINKS: ["index.htm","effettua_login.htm","creazione_di_una_cartella_clinica.htm","visualizza_cartella_clinica_attiva.htm","aggiornamento_cartella_clinica.htm","visualizza_tutte_le_cartelle_cliniche.htm","prenota_un_esame.htm"],
